module.exports = {
  ...
  async down(queryInterface, Sequelize) {
    ...
    const transaction = await queryInterface.sequelize.transaction();
    try {
      await queryInterface.removeColumn('workflows', 'organizationId', {
        transaction,
      });

      await queryInterface.removeColumn('job_postings', 'organizationId', {
        transaction,
      });
      ...
      await queryInterface.removeColumn('workflows', 'type', { transaction });

      await queryInterface.removeColumn('workflows', 'description', {
        transaction,
      });

      await queryInterface.removeColumn('workflows', 'name', { transaction });

      await queryInterface.removeColumn('job_postings', 'status', {
        transaction,
      });

      await queryInterface.removeColumn('job_postings', 'posted_byId', {
        transaction,
      });
      ...
      await queryInterface.removeColumn('applications', 'applicantId', {
        transaction,
      });
