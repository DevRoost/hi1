    ...
    <>
      ...
      <SectionMain>
        ...
        <CardBox>
          ...
          <>
            <p className={'block font-bold mb-2'}>Job_postings organization</p>
            <CardBox
              className='mb-6 border border-gray-300 rounded overflow-hidden'
              hasTable
            >
              <div className='overflow-x-auto'>
                <table>
                  ...
                  <tbody>
                    {organizations.job_postings_organization &&
                      Array.isArray(organizations.job_postings_organization) &&
                      organizations.job_postings_organization.map(
                        (item: any) => (
                          <tr
                            key={item.id}
                            onClick={() =>
              ...
              {!organizations?.job_postings_organization?.length && (
                <div className={'text-center py-4'}>No data</div>
              )}
            </CardBox>
          </>
          ...
          <>
            <p className={'block font-bold mb-2'}>Workflows organization</p>
            <CardBox
              className='mb-6 border border-gray-300 rounded overflow-hidden'
              hasTable
            >
              <div className='overflow-x-auto'>
                <table>
                  ...
                  <tbody>
                    {organizations.workflows_organization &&
                      Array.isArray(organizations.workflows_organization) &&
                      organizations.workflows_organization.map((item: any) => (
                        <tr
                          key={item.id}
                          onClick={() =>
                            router.push(
                              `/workflows/workflows-view/?id=${item.id}`,
                            )
                          }
                        >
              ...
              {!organizations?.workflows_organization?.length && (
                <div className={'text-center py-4'}>No data</div>
              )}
            </CardBox>
          </>
