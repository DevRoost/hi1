...
module.exports = class OrganizationsDBApi {
  ...
  static async findBy(where, options) {
    ...
    output.job_postings_organization =
      await organizations.getJob_postings_organization({
        transaction,
      });

    output.workflows_organization =
      await organizations.getWorkflows_organization({
        transaction,
      });
