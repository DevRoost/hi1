...
import {
  ...
  setRefetch,
  deleteItemsByIds,
} from '../../stores/workflows/workflowsSlice';
import { useAppDispatch, useAppSelector } from '../../stores/hooks';
import { useRouter } from 'next/router';
import { Field, Form, Formik } from 'formik';
import { DataGrid, GridColDef } from '@mui/x-data-grid';
import { loadColumns } from './configureWorkflowsCols';
...
const TableSampleWorkflows = ({
  ...
  useEffect(() => {
    if (workflowsNotify.showNotification) {
      notify(
        workflowsNotify.typeNotification,
        workflowsNotify.textNotification,
      );
    }
  }, [workflowsNotify.showNotification]);
  ...
  const handleViewAction = (id: string) => {
    router.push(`/workflows/workflows-view/?id=${id}`);
  };
  ...
  return (
    <>
      ...
      {workflows && Array.isArray(workflows) && !showGrid && (
        <ListWorkflows
          workflows={workflows}
          loading={loading}
...
export default TableSampleWorkflows;
